...
files = ['rewards_all_or.txt','../experiment_or/rewards_purple.txt', '../experiment_or/rewards_blue.txt',
         '../experiment_or/rewards_blue_or_purple.txt']
names = ['Baseline', 'Purple', 'Blue', 'Or']
colours = ['#32bc70', '#9467bd', '#1f77b4', '#FF4136']
